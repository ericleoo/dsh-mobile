 ...
 *  5. Touch polish: safe-area insets for notched phones, overscroll
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
       ...
       * full-width below (see the structure note in the file header). */
      ...
      /* Full-bleed shell + sheet column layout. */
      "  div[role='presentation'] { align-items: stretch; padding: 0 !important; }",
      ...
      "  div[role='presentation'] > div[role='dialog'] > div {",
      "    flex: 1; min-height: 0; width: 100%;",
      "  }",
      "  div[role='presentation'] > div[role='dialog'] > div > .VOzbGW_options {",
